    ...
    <div class="row">
        ...
        <?php
            ...
            if(isset($_GET['p_id'])){
                ...
                // everytime we visit this post_id, increment post_views_count
...
<?php 
    ...
    // $_POST['create_comment'] from below Comments Form  
    if(isset($_POST['create_comment'])) {
        ...
        // check comment not empty, then enable to be submitted
    ...
    } // if(isset($_POST['create_comment'])) end

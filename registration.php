...
if($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	login_user_after_register($username, $password);
                ...
                <h1>Register</h1>
                    <form role="form" action="registration.php" method="post" id="login-form" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <!-- if input error, keep the previous input in each input blank, so that the user doesn't need to input all of them again -->
                            <!-- by using  autocomplete="on"  -->

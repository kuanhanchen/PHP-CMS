...
if(isset($_GET['delete'])){
    ...
    // make sure user login and is admin, then can do delete
    //otherwise, without this if statement, we can be in index.php without login status and use url: admin/users.php?delete=38, then delete the user data with id=38
